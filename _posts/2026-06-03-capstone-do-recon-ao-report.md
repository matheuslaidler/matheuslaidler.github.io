...
> 💡 **PII** (*Personally Identifiable Information*) é dado pessoal que identifica alguém: nome, CPF, e-mail, telefone, dados financeiros. Vazar PII costuma ser High/Critical.

> 💡 **ATO** (*Account Takeover*) é tomar conta da conta de outra pessoa, via login, sessão ou recuperação de senha quebrados. É um dos achados que mais paga.
...
Tenho três pistas. Não dá pra atacar tudo de uma vez com cabeça, então **priorizo** com base no que o escopo disse que paga e no esforço pra confirmar:
...
### Aí a ficha caiu: voltar pro `?ref=` com outros olhos
...
Antes de reportar, sempre pergunto: **essa primitiva destrava outra coisa?** Encadear é o que transforma um High num Critical (a arte do encadeamento tem post próprio, o [26 — Chaining](/posts/chaining-vulnerabilidades/)).
